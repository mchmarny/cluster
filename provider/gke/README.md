...
cd provider/gke/terraform

# Create your configuration file
cp config/gke-demo.yaml config/gke-my-cluster.yaml
# Edit config/gke-my-cluster.yaml with your settings
```
...
```bash
provider/gke/tools/setup -c config/gke-my-cluster.yaml
```
...
```bash
provider/gke/tools/actuate -c config/gke-my-cluster.yaml
```
